/**********************************************************
			 ...
			 Para el curso de Métodos numéricos
						  CIMAT 5/12/22
Resuelve el sistema dinámico de Three-Scroll Unified CS
***********************************************************/
#include <stdio.h>
#include <stdlib.h>
#include <math.h>
...
double dx(double t, double x, double y, double z){ return(ALPHA*(y-x) + DELTA*x*z); }
double dy(double t, double x, double y, double z){ return(BETA*x - x*z + ZETA*y); }
double dz(double t, double x, double y, double z){ return(GAMMA*z + x*y - EPSILON*x*x); }
