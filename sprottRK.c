/**********************************************************
			 ...
			 Para el curso de Métodos numéricos
						  CIMAT 5/12/22
Resuelve el sistema dinámico de Sprott usando Runge Kutta 4
***********************************************************/
#include <stdio.h>
#include <stdlib.h>
#include <math.h>
...
double dx(double t, double x, double y, double z){ return(y + ALPHA*x*y + x*z); }
double dy(double t, double x, double y, double z){ return(1.0 - BETA*x*x + y*z); }
double dz(double t, double x, double y, double z){ return(x - x*x - y*y); }
