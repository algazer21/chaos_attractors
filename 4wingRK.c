...
Alan García Zermeño
5/12/22
Resuelve el sistema dinámico de four-wing usando Runge Kutta 4
***********************************************************/
#include <stdio.h>
#include <stdlib.h>
#include <math.h>
...
double dy(double t, double x, double y, double z){ return(BETA*x + GAMMA*y - x*z); }
double dz(double t, double x, double y, double z){ return(-z - x*y); }

int main(){
	unsigned int n = 14000;
	double dt = 0.03;
